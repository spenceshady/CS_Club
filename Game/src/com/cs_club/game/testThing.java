 ...
 */
public class testThing extends SimpleBaseGameActivity implements IAccelerationListener, IOnSceneTouchListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	protected ITexture mBoxFaceTexture;
	protected ITiledTextureRegion mBoxFaceTextureRegion;
	protected ITexture mBallTexture;
	protected ITiledTextureRegion mBallTextureRegion;
	...
	public void onCreateResources() throws IOException {
		...
		this.mBallTexture = new AssetBitmapTexture(this.getTextureManager(), this.getAssets(), "gfx/face_circle_tiled.png", TextureOptions.BILINEAR);
		this.mBallTextureRegion = TextureRegionFactory.extractTiledFromTexture(this.mBallTexture, 2, 1);
	...
	public Scene onCreateScene() {
		...
		this.mScene.getBackground().setColor(0, 0, 0);
	...
	private void addFace(final float pX, final float pY) {
		...
		if(this.mSpriteCount % 2 == 0) {
			animatedSprite = new AnimatedSprite(pX, pY, this.mBallTextureRegion, this.getVertexBufferObjectManager());
			animatedSprite.setScale(MathUtils.random(0.5f, 1.25f));
